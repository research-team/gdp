...
m = nest.Create('multimeter', params={'withtime': True, 'interval': 0.1, 'record_from': ['V_m', 'I_Na', 'I_K']})

# Create spike generators and connect
gex = nest.Create('spike_generator', params={'spike_times': np.array([0.5])})
gin = nest.Create('spike_generator', params={'spike_times': np.array([0.1])})
...
pl.subplot(212)
pl.plot(t, events['I_Na'], t, events['I_K'])
